...
def main():
    ...
    parser.add_argument('--model_url', default='https://drive.google.com/uc?export=download&id=1JlfBtwCbBauc_4o1l4lp1p3mkO3Zy8vB', help='Fetch a StyleGAN model to train on from this URL') # karras2019stylegan-ffhq-1024x1024.pkl
    ...
    if (args.use_lpips_loss > 0.00000001):
        with dnnlib.util.open_url('https://drive.google.com/uc?export=download&id=1GtIpx4vfs2d3nbhXbme9CItRVuGN51mM', cache_dir=config.cache_dir) as f:
